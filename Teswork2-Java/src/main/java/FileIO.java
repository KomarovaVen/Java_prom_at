...
public class FileIO {
    ...
    void writeToys(String mapState) {
        try {
            BufferedWriter wr = new BufferedWriter(
                    new OutputStreamWriter(new FileOutputStream("./tr.txt"), StandardCharsets.UTF_8));
    ...
    public static BufferedWriter raffleLog() throws IOException {
        ...
        BufferedWriter bw = new BufferedWriter(
                new OutputStreamWriter(new FileOutputStream("./rez.txt", true), StandardCharsets.UTF_8));
